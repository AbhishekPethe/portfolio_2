        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='max-sm:block md:hidden text-3xl'>
              <MdOutlineKeyboardDoubleArrowDown onClick={()=>setMenu(true)} />
                  ...
                  <div className={`absolute bg-white top-0 left-0 h-full w-full text-black flex flex-col justify-center items-center gap-20 ease-out duration-700 ${menu === true ? 'top-0' : '-top-[100%]'} [&>*:nth-child(n)]:font-bold `}>
